        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              if (CurrentUser.isLoggedIn && !AppConfig.isPremium!)
                AccountListTile(
              ...
              AccountListTile(
                ...
                onTapFunc: () async {
                  final Uri _emailLaunchUri = Uri(
                    scheme: 'mailto',
                    path: 'support@' + APIHelper.BASE_URL, // Put your Support Email Here
