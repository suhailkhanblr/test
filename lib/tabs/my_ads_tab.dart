      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            indicatorWeight: 4,
            indicatorColor: Color(0xFF2E2E3D),
            labelColor: Colors.black,
            tabs: [
              Tab(
                text: langPack['ADS']!.toUpperCase(),
              ),
              Tab(
                text: langPack['Favourites']!.toUpperCase(),
              ),
            ],
          ),
          title: Text(langPack['My Ads']!,
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    langPack['Heavy discount on Packages']!,
                                    softWrap: true,
                                    maxLines: null,
                                    style: TextStyle(
                                      color: Colors.white,
