...
class Products with ChangeNotifier {
  ...
  Future<List<Category>> fetchCategories(String countryCode) async {
    List<Category> fetchedCategories = [];
    final appConfigConvertedData =
        await apiHelper.fetchAppConfiguration(langCode: countryCode);
    final categories = appConfigConvertedData['categories'];
  ...
  Future fetchHomeLatestProducts(
      {required Location userLocation, page, limit}) async {
    List<Product> fetchedProducts = [];
