...
class AppConfig {
  ...
  static String termsOfUseURL = APIHelper.BASE_URL + '/page/term-condition';
  static String privacyPolicy = 'Privacy Policy';
  static String privacyPolicyURL = APIHelper.BASE_URL + '/page/privacy-policy';
  ...
  static bool? disableMobileNumberLogin;
  ...
  static Future initialize() async {
    ...
    disableMobileNumberLogin = decodedData['disable_mobile_number_login'];
    // isPremium = false;
