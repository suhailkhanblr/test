...
void main() async {
  ...
  _languages.fetchLanguagePackModel();
  // Import package
...
class MyApp extends StatelessWidget {
  ...
  const MyApp(
      {Key? key, @required this.isFreshInstalled, required this.languages})
      : super(key: key);
      ...
      child: Directionality(
        ...
        child: new MaterialApp(
          ...
          routes: {
            ...
            LoginScreenScreen.routeName: (ctx) => LoginScreenScreen(),
            CreateAccountWithPhoneScreen.routeName: (ctx) =>
                CreateAccountWithPhoneScreen(),
            ForgotPasswordScreen.routeName: (ctx) => ForgotPasswordScreen(),
            LoginWithMobileNumberScreen.routeName: (ctx) => LoginWithMobileNumberScreen(),
          },
        ),
      ),
    );
