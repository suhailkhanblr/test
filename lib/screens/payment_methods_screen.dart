...
import 'package:Duet_Classified/payment/PaypalPayment.dart';
...
class _PaymentMethodsScreenState extends State<PaymentMethodsScreen> {
  ...
  Widget build(BuildContext context) {
    var langPack = Provider.of<Languages>(context).selected;
                  ...
                  children: [
                    Container(
                      constraints: BoxConstraints(
                          ...
                          maxHeight: MediaQuery.of(context).size.width / 6.5),
                      child: Image.asset(
