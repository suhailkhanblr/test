      ...
      appBar: AppBar(
        ...
        actions: [
          (CurrentUser.textDirection == TextDirection.rtl)
              ? IconButton(
                  icon: Icon(Iconsax.arrow_right_3, color: Colors.black),
                  onPressed: () async {
                    Navigator.pushNamedAndRemoveUntil(context,
                        TabsScreen.routeName, (Route<dynamic> route) => false);
                  },
        ...
        //                           if (CurrentUser.location.name != null ||
        //                               CurrentUser.location.name != '') {
        //                             return Text('${CurrentUser.location.name}');
        //                           }
        //                           if (data.prodLocationGetter.name == '') {
        //                             return child!;
        //                           }
                  ...
                  child: Container(
                    ...
                    child: TextField(
                        ...
                        decoration: InputDecoration(
                            ...
                            hintText: langPack['What are you looking for?'],
                      ...
                      return Column(
                        ...
                        children: [
                          if (!firstBuild)
                            GridView.builder(
                              itemCount:
                                  foundProducts.length % productLimit == 0
                                      ? productLimit
                                  ...
                                  return ProductItem(
                                    ...
                                    price: double.parse(
                                        foundProducts[i * productLimit + index]
                                            ...
                                            : foundProducts[i * productLimit +
                                                index]['price']),
                                    location: foundProducts[i * productLimit +
                                            index]['location'] ??
                                        foundProducts[i * productLimit + index]
                                            ['city'] ??
                                        ...
                                        itemBuilder: (ctx, index) {
                                          return ProductItem(
                                            ...
                                            location: snapshot.data[
                                                ...
                                                CurrentUser.prodLocation.name ??
                                                '',
                                            isFeatured: snapshot.data[i *
                                                            productLimit +
                                                        index]['featured'] ==
                                                    '1'
                                                ? true
                                                : false,
                                            isUrgent: snapshot.data[
                                                        i * productLimit +
                                                            index]['urgent'] ==
                                                    '1'
                                                ? true
