...
class _NewAdScreenState extends State<NewAdScreen> {
  ...
  Future<Map> _trySubmit(BuildContext ctx, cat, subCat) async {
    ...
    if (isValid) {
      ...
      if (await apiHelper.checkUserPostLimit(userId: CurrentUser.id) == false) {
        final response = await apiHelper.postUserProduct(
          ...
          additionalInfo: _additionalInfo.cast<Map<String, String>>().toList(),
  ...
  Widget build(BuildContext context) {
    ...
    final Map pushedMap = ModalRoute.of(context)!.settings.arguments as Map;
                      ...
                      children: [
                        ...
                        TextButton(
                          ...
                          onPressed: () async {
                            ...
                            _additionalInfo = result as List<dynamic>;
                          },
