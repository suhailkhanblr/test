...
class _EditAdScreenState extends State<EditAdScreen> {
  late Map<String, dynamic> prodData;
  ...
  Widget build(BuildContext context) {
    ...
    if (firstLaunch) {
      ...
      _additionalInfo = prodData['custom_data'];
      ...
      _location = (prodData['location'] == "")
          ? "${prodData['city']},${prodData['state']},${prodData['country']}"
          : prodData['location'];
                        ...
                        label: Consumer<CurrentUser>(
                            ...
                            builder: (ctx, data, child) {
                              if (data.prodLocationGetter.name == '') {
                                if (CurrentUser.prodLocation.name != '')
                                  return Text(CurrentUser.prodLocation.name);
                                else
                                  return child!;
                              }
